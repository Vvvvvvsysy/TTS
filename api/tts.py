...
if __name__ == "__main__":
    ...
    import os
    import time
    with open("/home/wenjun.feng/tts/tts_script/python_cli_demo/bascase.txt","w") as f:

        # wav_path_all = ["/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/voice_1/", "/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/voice_2/", "/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/voice_3/", "/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/voice_4/"]
        # xml_path_all = ["/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/xml1/", "/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/xml2/", "/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/xml3/","/home/wenjun.feng/tts/tts_script/python_cli_demo/voice/xml4/"]
        ...
        for xml_path, wav_path in zip(xml_path_all, wav_path_all):
            ...
            for xml_file in os.listdir(xml_path):
                try:
                    ...
                    SSML_text = get_SSML(xml_file_path)
                    output_path = wav_path + xml_file.split(".")[0]+".mp3"
                    asyncio.get_event_loop().run_until_complete(mainSeq(SSML_text, output_path))
                    print(xml_file + 'completed')
                    # print("time sleep 2s")
                    # time.sleep(5)
                except:
